...
extension Config {
    ...
    struct DebugWindow: BoolConfigItem {
        ...
        static var key: String = "dev.yuta.inputmethod.azooKeyMac.preference.debug.enableDebugWindow"
    }
    /// ライブ変換を有効化する設定
    struct LiveConversion: BoolConfigItem {
        static let `default` = true
        static var key: String = "dev.yuta.inputmethod.azooKeyMac.preference.enableLiveConversion"
    }
    /// 円マークの代わりにバックスラッシュを入力する設定
    struct TypeBackSlash: BoolConfigItem {
        static let `default` = false
        static var key: String = "dev.yuta.inputmethod.azooKeyMac.preference.typeBackSlash"
    }
    /// 「、」「。」の代わりに「,」「.」を入力する設定
    struct TypeCommaAndPeriod: BoolConfigItem {
        static let `default` = false
        static var key: String = "dev.yuta.inputmethod.azooKeyMac.preference.typeCommaAndPeriod"
    }
    /// 「　」の代わりに「 」を入力する設定
    struct TypeHalfSpace: BoolConfigItem {
        static let `default` = false
        static var key: String = "dev.yuta.inputmethod.azooKeyMac.preference.typeHalfSpace"
    }
    /// Zenzaiを利用する設定
    struct ZenzaiIntegration: BoolConfigItem {
        static let `default` = true
        static var key: String = "dev.yuta.inputmethod.azooKeyMac.preference.enableZenzai"
    }
    /// OpenAI APIキー
    ...
    struct IncludeContextInAITransform: BoolConfigItem {
        static let `default` = true
        static var key: String = "dev.yuta.inputmethod.azooKeyMac.preference.includeContextInAITransform"
    }
}
